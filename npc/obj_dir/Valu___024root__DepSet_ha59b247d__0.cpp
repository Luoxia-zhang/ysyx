...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelf->alu__DOT__w = (0xfU & ((- (IData)((IData)(vlSelf->cin))) 
                                   ^ (IData)(vlSelf->b)));
    vlSelf->carry = (1U & (((IData)(vlSelf->a) + ((IData)(vlSelf->alu__DOT__w) 
                                                  + (IData)(vlSelf->cin))) 
                           >> 4U));
    vlSelf->result = (0xfU & ((IData)(vlSelf->a) + 
                              ((IData)(vlSelf->alu__DOT__w) 
                               + (IData)(vlSelf->cin))));
    vlSelf->zero = (1U & (~ (IData)((0U != (IData)(vlSelf->result)))));
    vlSelf->overflow = (((1U & ((IData)(vlSelf->a) 
                                >> 3U)) == (1U & ((IData)(vlSelf->alu__DOT__w) 
                                                  >> 3U))) 
