...
VL_ATTR_COLD void Vkeyboard___024root___ctor_var_reset(Vkeyboard___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->keyboard__DOT__fifo[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->keyboard__DOT__w_ptr = VL_RAND_RESET_I(3);
    vlSelf->keyboard__DOT__r_ptr = VL_RAND_RESET_I(3);
    vlSelf->keyboard__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->keyboard__DOT__ps2_clk_sync = VL_RAND_RESET_I(3);
    vlSelf->keyboard__DOT____Vlvbound_h1a91ade8__0 = VL_RAND_RESET_I(1);
