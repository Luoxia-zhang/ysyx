...
class VFSM_bin___024root final : public VerilatedModule {
  public:
    ...
    VlUnpacked<CData/*4:0*/, 9> FSM_bin__DOT__outMux__DOT__pair_list;
    VlUnpacked<CData/*3:0*/, 9> FSM_bin__DOT__outMux__DOT__key_list;
    VlUnpacked<CData/*0:0*/, 9> FSM_bin__DOT__outMux__DOT__data_list;
    VlUnpacked<CData/*7:0*/, 9> FSM_bin__DOT__stateMux__DOT__pair_list;
    VlUnpacked<CData/*3:0*/, 9> FSM_bin__DOT__stateMux__DOT__key_list;
    VlUnpacked<CData/*3:0*/, 9> FSM_bin__DOT__stateMux__DOT__data_list;
