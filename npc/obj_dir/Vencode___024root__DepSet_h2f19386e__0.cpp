...
extern const VlUnpacked<CData/*1:0*/, 32> Vencode__ConstPool__TABLE_hcfb368ec_0;
extern const VlUnpacked<CData/*1:0*/, 32> Vencode__ConstPool__TABLE_h14202f14_0;
extern const VlUnpacked<IData/*31:0*/, 32> Vencode__ConstPool__TABLE_hbc2d5e8c_0;
...
VL_INLINE_OPT void Vencode___024root___ico_sequent__TOP__0(Vencode___024root* vlSelf) {
    ...
    vlSelf->y = Vencode__ConstPool__TABLE_hcfb368ec_0
        [__Vtableidx1];
    if ((2U & Vencode__ConstPool__TABLE_h14202f14_0
         [__Vtableidx1])) {
        vlSelf->i = Vencode__ConstPool__TABLE_hbc2d5e8c_0
            [__Vtableidx1];
    }
}
...
#endif
                VL_FATAL_MT("vsrc/encode.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/encode.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/encode.v", 1, "", "NBA region did not converge.");
            }
